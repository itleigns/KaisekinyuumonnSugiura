...
$x\geqq 0,y\leqq 0$の時$f(xy) = -f(x(-y))=-(f(x)f(-y))=f(x)f(y)$より成立.

$x\leqq 0,y\geqq 0$の時$f(xy) = -f((-x)y)=-(f(-x)f(y))=f(x)f(y)$より成立.

$x\leqq 0,y\leqq 0$の時$f(xy) = f((-x)(-y))=f(-x)f(-y)=f(x)f(y)$より成立.
...
$x\leqq 0,y\geqq 0$の時$x\geqq 0,y\leqq 0$のときと同様に成立.
